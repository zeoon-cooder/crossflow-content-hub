...
const Footer = () => {
  return (
    <footer className="bg-dark-500 pt-12 pb-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-12">
          <div className="col-span-2">
            ...
            <p className="text-gray-300 mb-6">
              The all-in-one video publishing automation platform for content creators.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/changelog" className="text-gray-300 hover:text-white transition-colors">Changelog</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-700 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              &copy; {new Date().getFullYear()} CrossPostify. All rights reserved.
            </p>
